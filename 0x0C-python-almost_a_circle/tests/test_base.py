...
class TestBase_instantiation(unittest.TestCase):
    """Represents Unittests for testing instantiation of the Base class."""
...
class TestBase_to_json_string(unittest.TestCase):
    """Represents Unittests for testing to_json_string method of Base class."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Represents Unittests for testing save_to_file method of Base class."""
...
class TestBase_create(unittest.TestCase):
    """Represents Unittests for testing
for create method of Base class."""
