#!/usr/bin/python3
"""Defines unittests for test_rectangle.py.
...
class TestRectangle_instantiation(unittest.TestCase):
    """Represents Unittests for testing
...
class TestRectangle_width(unittest.TestCase):
    """Represents Unittests for testing
initialization of Rectangle width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """Represents Unittests for testing
initialization of Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Represents Unittests for testing
initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Represents Unittests for testing
initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Represents Unittests for testing
Rectangle order of attribute initialization."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Represents Unittests for testing __str__ and
display methods of Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """Module that captures and returns text printed to stdout.
...
class TestRectangle_update_args(unittest.TestCase):
    """Represents Unittests for testing
update args method of the Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Represents Unittests for testing
update kwargs method of the rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Represents Unittests for testing
 to_dictionary method of the rectangle class."""
